...
const Cart = () => {
  ...
  const onCompletePurchaseTextClick = useCallback(() => {
    navigate("/check-out");
  }, [navigate]);

  return (
    <div className="relative bg-gray-200 w-full h-[2717px] overflow-hidden text-left text-5xl text-black-black-100 font-button-16">
      <img
        className="absolute top-[0px] left-[0px] w-[1948px] h-[6593px]"
        alt=""
        src="/gradient-color4.svg"
      />
      ...
      <img
        ...
        src="/globe-2.svg"
      />
      <div className="absolute top-[881px] left-[calc(50%_-_721px)] w-[1441px] h-[115px] overflow-hidden">
        <div className="absolute top-[20px] left-[-1452px] w-[2872px] h-9">
          ...
          <img
            className="absolute top-[20px] left-[-544px] w-9 h-9 overflow-hidden"
            alt=""
            src="/globe-2.svg"
          />
          <img
            className="absolute top-[20px] left-[-1026px] w-9 h-9 overflow-hidden"
            alt=""
            src="/globe-2.svg"
          />
          <img
            className="absolute top-[20px] left-[-62px] w-9 h-9 overflow-hidden"
            alt=""
            src="/globe-2.svg"
          />
          <div className="absolute top-[3px] left-[1446px] uppercase font-light">
            BRAND KLIN NEW LAUNCHES NFT!
          </div>
          <div className="absolute top-[3px] left-[1928px] uppercase font-light">
            BRAND KLIN NEW LAUNCHES NFT!
          </div>
          <div className="absolute top-[3px] left-[2410px] uppercase font-light">
            BRAND KLIN NEW LAUNCHES NFT!
          </div>
          <img
            className="absolute top-[0px] left-[1872px] w-9 h-9 overflow-hidden"
            alt=""
            src="/globe-2.svg"
          />
          <img
            className="absolute top-[0px] left-[2354px] w-9 h-9 overflow-hidden"
            alt=""
            src="/globe-2.svg"
          />
          <img
            className="absolute top-[0px] left-[2836px] w-9 h-9 overflow-hidden"
            alt=""
            src="/globe-2.svg"
          />
        </div>
      ...
      <div className="absolute top-[1768px] left-[76px] w-[1360px] h-[502px] text-lg">
      ...
      <div className="absolute top-[2384px] left-[calc(50%_-_150px)] rounded-31xl flex flex-row py-2.5 px-8 items-center justify-start gap-[10px] text-lg border-[1px] border-solid border-black-black-100">
      ...
      <div className="absolute top-[981px] left-[calc(50%_-_756px)] w-[1535px] h-[814px] text-center text-31xl">
        <img
          className="absolute top-[49.27px] left-[calc(50%_-_729.12px)] w-[1469.98px] h-[657.63px] object-cover"
          alt=""
        ...
        <img
          ...
          src="/avatar-1@2x.png"
        />
        <div className="absolute top-[212.07px] left-[0px] w-[1535px] h-[601.93px]">
          <div className="absolute top-[133px] left-[calc(50%_-_519.5px)] w-[1040px] h-[376px] flex flex-col items-center justify-start gap-[32px]">
            ...
            <div className="relative rounded-3xs [background:linear-gradient(225deg,_#18c8ff,_#933ffe)] w-[156px] h-14 overflow-hidden shrink-0 text-base">
      ...
      <div className="absolute top-[159px] left-[calc(50%_-_724px)] w-[1447px] h-[674px] text-61xl">
        ...
        <img
          ...
          src="/image-2@2x.png"
        />
        <div className="absolute top-[665px] left-[calc(50%_-_96.5px)] w-[193px] h-[9px]">
      ...
      <div className="absolute bottom-[-129922px] left-[62px] w-[1387px] h-[130193px] text-13xl">
        <div className="absolute bottom-[130137px] left-[0px] text-27xl">
          Brand Kiln NFT
        </div>
        <div className="absolute bottom-[130052px] left-[0px]">Facebook</div>
        <div className="absolute bottom-[130052px] left-[232px]">Twittter</div>
        <div className="absolute bottom-[130052px] left-[433px]">Instagram</div>
      ...
      <div className="absolute top-[-39px] left-[-17px] w-[1584px] h-[179px]">
        ...
        <div className="absolute top-[64px] left-[1109px] w-[325px] h-[49px]">
          ...
          <img
            className="absolute h-[59.63%] w-[8.62%] top-[20.41%] right-[4.62%] bottom-[19.96%] left-[86.77%] max-w-full overflow-hidden max-h-full object-cover"
            alt=""
            src="/mask-group1@2x.png"
          />
          <img
            className="absolute top-[11px] left-[15px] w-7 h-7 object-cover"
            alt=""
            src="/mask-group2@2x.png"
          />
          <div className="absolute h-[59.18%] w-[55.89%] top-[18.37%] left-[19.08%] leading-[160%] font-medium inline-block">
            Connect wallet
          </div>
      ...
      <div className="absolute top-[-26px] left-[0px] bg-gray-400 w-[1512px] h-[2743px]" />
      <div className="absolute top-[140px] left-[1121px] rounded-xl bg-black-black-100 shadow-[0px_4px_4px_#000] w-[358px] h-[812px]" />
      <div className="absolute top-[222px] left-[1132px] box-border w-[336px] h-0.5 border-t-[2px] border-solid border-black" />
      <div className="absolute top-[161px] left-[1152px] w-[297px] h-[38px] text-black">
        <div className="absolute top-[0px] left-[0px] leading-[160%] font-extralight [-webkit-text-stroke:1px_#000]">
          Your cart
        </div>
        <img
          className="absolute top-[16px] left-[106px] w-3.5 h-3.5 object-cover"
          alt=""
          src="/info@2x.png"
        />
        <img
          className="absolute top-[12px] left-[279px] w-[18px] h-[18px] object-cover cursor-pointer"
          alt=""
          src="/delete@2x.png"
          onClick={onDeleteIconClick}
        />
      </div>
      <div className="absolute top-[316px] left-[1188px] text-xl leading-[160%] font-extralight text-black">
        Add items to get started
      </div>
      <div className="absolute top-[441px] left-[1147px] rounded-mini bg-violet w-[306px] h-[60px]" />
      <div
        className="absolute top-[456px] left-[1213px] text-lg leading-[160%] font-extrabold cursor-pointer"
        onClick={onCompletePurchaseTextClick}
      >
        Complete purchase
      </div>
    </div>
